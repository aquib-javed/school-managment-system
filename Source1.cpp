...
void Student::log_in_admin()
{
	...
	ifstream admin_file("admin-password.txt");
		...
		while (student_file)
		{
			...
			if (var[17] == sort)
			{
				...
				do
				{
					...
					if (b > 50) ////////ya condition theek karo 50 say neechay b enter karo toh b cout kar dayta ha     a<=50 lagao
					{
						cout << "\t\t\t\tMarks should be less than or equal to 50 ! " << endl;
					}
				} while (b > 50);
...
void function::display_final()
{
	...
	cout << "\t\t\t\t\t -----------------------" << endl;
	cout << "\t\t\t\t\t|                       |" << endl;
	cout << "\t\t\t\t\t|     KAHANI KHATAM     |" << endl;
	cout << "\t\t\t\t\t|                       |" << endl;
	cout << "\t\t\t\t\t -----------------------" << endl;
	cout << "\t\t\t\t\t   All Rites Reserved " << endl;          /////////////rites k rights  
	cout << "\n";
	cout << "\t\t\t\t\t   |  Aquib  Javed  |" << endl;
	cout << "\t\t\t\t\t   |  Abrar Hameed  |" << endl;  ///////// abrar youtube wlay 
	cout << "\n";
	cout << "\t\t\t\t\t       Thank You" << endl;

	/*			if u guys are booored frome taking viva go to my youtube channal and watch my latest video
															or
							han agar video achi lagi toh subscribe karna na bhoolna
	*/
}
